...
//            jdbc:mysql://127.0.0.1:3306/?user=root
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/MyDb","root","Tdutbq21@sql");
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/MyDb","root","Tdutbq21@sql")){
                System.out.println("Sql select");
...
//                System.out.println("Deleted "+result + " rows");
                ...
                //Удалить ВСЕ строки
//                String sqlScript = "delete from Cars";
//                int result =  statement.executeUpdate(sqlScript);
//                System.out.println("Deleted "+result + " rows");

                String sqlScript = "insert INTO Cars (marka,model,year) values ('BMW','X5',2022);";
                int result =  statement.executeUpdate(sqlScript);
                System.out.println("Inserted "+result + " rows");
